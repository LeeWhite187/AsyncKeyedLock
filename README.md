NOTE: This fork was created only to persist the library for myself, in case the original is deleted.
Please see the original repository page for discussion, praise, issues, etc: https://github.com/MarkCiliaVincenti/AsyncKeyedLock
